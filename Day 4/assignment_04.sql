...
SELECT category_question.*, COUNT(question_id) as "Quantity"
FROM category_question
LEFT JOIN question USING(category_id)
GROUP BY category_id;

-- Question 7: Thông kê mỗi Question được sử dụng trong bao nhiêu Exam
SELECT question.* , COUNT(exam_id) as "Quantity exam"
FROM question
LEFT JOIN exam_question USING(question_id)
GROUP BY question_id;

-- Question 8: Lấy ra Question có nhiều câu trả lời nhất
SELECT question.*, COUNT(answer_id) as "Quantity"
FROM question
...
SELECT position.* ,COUNT(account.account_id) as "Quantity"
FROM position
INNER JOIN account USING(position_id)
GROUP BY position_id
ORDER BY COUNT(account.account_id) ASC
LIMIT 1;

-- Question 11: Thống kê mỗi phòng ban có bao nhiêu dev, test, scrum master, PM
-- Question 12: Lấy thông tin chi tiết của câu hỏi bao gồm: thông tin cơ bản của question, loại câu hỏi, ai là người tạo ra câu hỏi, câu trả lời là gì,
SELECT question.question_id,question.content,account.full_name as "creator_name",category_question.category_name,answer.content, answer.is_correct
FROM question
...
SELECT type_question.*, COUNT(question.question_id) as "Quantity"
FROM type_question
